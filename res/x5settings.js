(function ( $, x5engine ) {
	...
	s.siteId = '670F007EFE748116EA6A7469D9496671';
	s.islocal = true;
	$.extend(true, s , {
		"imCart": {
			"slugToProductIdMap": {},
	...
	b.push(function () {
		x5engine.captcha.instance = new x5engine.captcha.x5captcha({
			"offlineCodes": {
				"0": { letter: 'U', path: 'captcha/imcpa_jlm.gif'},
				"1": { letter: 'D', path: 'captcha/imcpa_gta.gif'},
				"2": { letter: '2', path: 'captcha/imcpa_p8g.gif'},
				"3": { letter: 'T', path: 'captcha/imcpa_4ks.gif'},
				"4": { letter: 'M', path: 'captcha/imcpa_27g.gif'},
				"5": { letter: 'S', path: 'captcha/imcpa_zn8.gif'},
				"6": { letter: 'L', path: 'captcha/imcpa_sxy.gif'},
				"7": { letter: '8', path: 'captcha/imcpa_dvp.gif'},
				"8": { letter: 'C', path: 'captcha/imcpa_fcd.gif'},
				"9": { letter: 'J', path: 'captcha/imcpa_mxn.gif'}
			}
		});
	}, false, 'first');
